...
export function normalizeIssue(
  ...
  const issue: IssueEntry = {
    ...
    linearIssueId: toStringValue(raw.linearIssueId) || undefined,
    linearIdentifier: toStringValue(raw.linearIdentifier) || undefined,
    linearUrl: toStringValue(raw.linearUrl) || undefined,
    linearTeamId: toStringValue(raw.linearTeamId) || undefined,
    linearProjectId: toStringValue(raw.linearProjectId) || undefined,
    linearSyncedAt: toStringValue(raw.linearSyncedAt) || undefined,
...
export function createIssueFromPayload(
  ...
  const issue: IssueEntry = {
    ...
    linearIssueId: toStringValue(payload.linearIssueId) || undefined,
    linearIdentifier: toStringValue(payload.linearIdentifier) || undefined,
    linearUrl: toStringValue(payload.linearUrl) || undefined,
    linearTeamId: toStringValue(payload.linearTeamId) || undefined,
    linearProjectId: toStringValue(payload.linearProjectId) || undefined,
    linearSyncedAt: toStringValue(payload.linearSyncedAt) || undefined,
...
export function buildRuntimeState(
  ...
  const mergedIssues = (previous?.issues ?? []).reduce<IssueEntry[]>((issues, rawIssue) => {
      ...
      issues.push({
        ...
        linearIssueId: toStringValue(existing.linearIssueId) || undefined,
        linearIdentifier: toStringValue(existing.linearIdentifier) || undefined,
        linearUrl: toStringValue(existing.linearUrl) || undefined,
        linearTeamId: toStringValue(existing.linearTeamId) || undefined,
        linearProjectId: toStringValue(existing.linearProjectId) || undefined,
        linearSyncedAt: toStringValue(existing.linearSyncedAt) || undefined,
